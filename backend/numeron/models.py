...
class User(models.Model):
    ...
    win_cpu = models.IntegerField(verbose_name="勝ち総ポイント(CPU)", null=True, default=0)
    win_count = models.IntegerField(verbose_name="勝ち数", null=True, default=0)
    lose_cpu = models.IntegerField(verbose_name="負け総ポイント(CPU)", null=True, default=0)
    draw_cpu = models.IntegerField(verbose_name="引き分け総ポイント(CPU)", null=True, default=0)
    win_friend = models.IntegerField(verbose_name="勝ち総ポイント(フレンド)", null=True, default=0)
    lose_friend = models.IntegerField(verbose_name="負け総ポイント(フレンド)", null=True, default=0)
    draw_friend = models.IntegerField(verbose_name="引き分け総ポイント(フレンド)", null=True, default=0)
